...
const DetailOne = () => {
    ...
    return (
        <div className="overflow-hidden">
            <SEO
                title="Insurance Insights | Coronation Insurance Ghana"
                description="Read in-depth insurance articles, news and expert insights from Coronation Insurance Ghana."
                keywords="insurance article, Coronation Insurance insights, insurance news Ghana"
            />
                ...
                <div className="max-w-7xl mx-auto lg:p-20 p-4">
                    <div className="flex lg:flex-row flex-col gap-10">
                        ...
                        <div className="lg:w-[413px] flex flex-col gap-10">
                            <div className="w-full p-6 bg-gradient-to-br from-[#F7F7F8] to-[#F3EAF8] border border-[#B580D1]/20 flex flex-col gap-4 rounded-2xl shadow-sm">
                                <h3 className="text-[16px] font-normal leading-[24px] text-[#56575D]">Connect with us</h3>
                                <ul className="flex gap-4">
                                    <a href="https://www.facebook.com/coronationghana" target="_blank" rel="noopener noreferrer"><li className="text-white lg:w-[48px] w-[40px] lg:h-[48px] h-[40px] bg-[#B580D1] flex items-center justify-center rounded-full shadow-lg shadow-[#B580D1]/30 transition-transform duration-300 hover:scale-110"><FaFacebook size={24} /></li></a>
                                    <a href="https://www.linkedin.com/authwall?trk=bf&trkInfo=AQHMuoEM6XPSiAAAAZrfHLGYn-DS8LzqjPiWMDWe82Qq14Hv-bXom2vIuCF4s-Cv_HTCQYFWyc9hqx5_P8m3gHSy5t2V_Vvx6Lkk-sp6YHY4YPY--ALn61dPZffzByp9eNypqOw=&original_referer=&sessionRedirect=https%3A%2F%2Fwww.linkedin.com%2Fcompany%2F76524378%2Fadmin%2Fpage-posts%2Fpublished%2F" target="_blank" rel="noopener noreferrer"><li className="text-white lg:w-[48px] w-[40px] lg:h-[48px] h-[40px] bg-[#B580D1] flex items-center justify-center rounded-full shadow-lg shadow-[#B580D1]/30 transition-transform duration-300 hover:scale-110"><FaLinkedin size={24} /></li></a>
                                    <a href="https://www.instagram.com/coronationgh/" target="_blank" rel="noopener noreferrer"><li className="text-white lg:w-[48px] w-[40px] lg:h-[48px] h-[40px] bg-[#B580D1] flex items-center justify-center rounded-full shadow-lg shadow-[#B580D1]/30 transition-transform duration-300 hover:scale-110"><FaInstagram size={24} /></li></a>
                                    <a href="https://x.com/coronationghana" target="_blank" rel="noopener noreferrer"><li className="text-white lg:w-[48px] w-[40px] lg:h-[48px] h-[40px] bg-[#B580D1] flex items-center justify-center rounded-full shadow-lg shadow-[#B580D1]/30 transition-transform duration-300 hover:scale-110"><FaTwitter size={24} /></li></a>
                                </ul>
                            </div>

                            <div className="w-full flex flex-col gap-5">
                                <div className="flex items-center gap-3">
                                    <span className="w-8 h-[3px] rounded-full bg-[#B580D1]" />
                                    <span className="text-[#B580D1] text-xs font-semibold tracking-widest uppercase">Latest Insights</span>
                                </div>
                                {insightLatestData.filter((article) => String(article.id) !== String(id)).slice(0, 2).map((article, index) => (
                                    ...
                                    >
                                        ...
                                        <div className="absolute inset-x-0 bottom-0 m-2.5 rounded-xl backdrop-blur-xl bg-white/10 border border-white/25 p-3 transition-colors duration-500 group-hover:bg-white/20">
                                            ...
                                            <span className="mt-1.5 inline-flex items-center gap-1.5 text-[#D8B9EA] text-[13px] font-semibold">
