...
const RedBook = ({ item }) => {
    return (
        <Link
            to={item.link || `/corporate/insights/${item.id}`}
            className="group relative block h-[420px] w-full rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl hover:shadow-[#FF0226]/40 transition-all duration-500 hover:-translate-y-2"
        >
