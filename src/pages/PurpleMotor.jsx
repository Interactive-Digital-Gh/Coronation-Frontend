        ...
        <div className="overflow-hidden">
                                ...
                                {isExpanded.comprehensive && (
                                    <>
                                        ...
                                        <div className="flex gap-4">
                                            ...
                                            <a href={motorFlyer} download="Coronation_Motor_Insurance_Flyer.pdf" className="w-[142px] h-[36px] bg-[#B580D1] font-semibold text-[14px] leading-[20px] cursor-pointer rounded-lg shadow-md text-white flex items-center justify-center mt-6">
                                                Download Flyer
                                            </a>
                                        </div>
                                    </>
            ...
            <section>
                <div className="relative">
                    ...
                    <div className="hidden bg-white absolute top-[48%] right-[7%] w-[108px] h-[44px] lg:flex rounded-lg items-center justify-center text-[16px] leading-[24px] font-semibold">
