...
const RedWhistleBlowing = () => {
    return (
        <div className="overflow-hidden">
            <SEO
                title="Whistle Blowing | Coronation Insurance Ghana - Corporate"
                description="Coronation Insurance Ghana corporate whistleblowing channel. Report misconduct, fraud or policy violations safely and confidentially."
                keywords="whistleblowing Coronation Insurance, corporate fraud reporting, ethics compliance Ghana"
            />
