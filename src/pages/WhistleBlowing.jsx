                ...
                <div className="max-w-[1200px] mx-auto px-4">
                    <div className="flex flex-col lg:flex-row gap-12 items-start">
                        <div className="flex-1">
                            ...
                            <div className="h-1 w-full bg-gradient-to-r from-[#00205B] via-[#B580D1] to-[#B580D1] mb-12"></div>
                            ...
                            <div className="flex flex-col gap-10">
                                ...
                                <div className="flex gap-6 items-start">
                                    <div className="bg-[#B580D1]/10 p-3 rounded-xl">
                                        <MdCall className="text-[#B580D1] text-4xl" />
                                    </div>
                                ...
                                <div className="flex gap-6 items-start">
                                    <div className="bg-[#B580D1]/10 p-3 rounded-xl">
                                        <MdPublic className="text-[#B580D1] text-4xl" />
                                    </div>
                                    <div>
                                        <p className="text-[#00205B] font-bold text-lg uppercase tracking-tight">WEBLINK</p>
                                        <a href="https://apps.ng.kpmg.com/ethics/#/" target="_blank" rel="noopener noreferrer" className="text-[18px] text-[#B580D1] hover:underline break-all">
                                ...
                                <div className="flex gap-6 items-start">
                                    <div className="bg-[#B580D1]/10 p-3 rounded-xl">
                                        <MdEmail className="text-[#B580D1] text-4xl" />
                                    </div>
                                    <div>
                                        <p className="text-[#00205B] font-bold text-lg uppercase tracking-tight">KPMG ETHICS LINE EMAIL</p>
                                        <a href="mailto:Kpmgethicsline@ng.kpmg.com" className="text-[18px] text-[#1A1A1A] hover:text-[#B580D1] transition-colors">
                                ...
                                <div className="flex gap-6 items-start">
                                    <div className="bg-[#B580D1]/10 p-3 rounded-xl">
                                        <MdLocationOn className="text-[#B580D1] text-4xl" />
                                    </div>
                                    <div>
                                ...
                                <div className="flex gap-6 items-start">
                                    <div className="bg-[#B580D1]/10 p-3 rounded-xl">
                                        <MdQrCodeScanner className="text-[#B580D1] text-4xl" />
                                    </div>
                                    <div>
                        ...
                        <div className="lg:w-[400px] w-full flex flex-col gap-6">
                            ...
                            <div className="bg-[#B580D1] p-6 rounded-2xl text-white">
