...
const MotorInsuranceGhana = () => {
    // Corporate visitors reach this page via /corporate/motor-insurance-ghana and get the red theme
    ...
    return (
        <div className="overflow-hidden">
            ...
            <div>
                <div className="flex lg:flex-row flex-col-reverse w-full lg:h-[450px] h-[678px]">
                    <div className="flex-1 flex-col bg-[#EFEFF0] flex lg:items-center justify-center">
                        <div className="p-4">
                            <h1 className="lg:text-[56px] text-[32px] lg:leading-[64px] leading-[40px] font-bold"
                    ...
                    <div className="">
                        <img
                            ...
                            alt="Motor insurance in Ghana - Coronation Insurance"
                            className="hidden lg:flex bg-cover w-full h-full"
                            loading="lazy" />
                        <img src={motormob} alt="Car insurance Ghana" className="flex lg:hidden bg-cover w-full h-[458px]" loading="lazy" />
                    </div>
                    <div className={`glass ${isCorporate ? "bg-[#FF0226] bg-opacity-70" : ""} absolute lg:bottom-[137px] md:bottom-[227px] small:bottom-[317px] nsm:bottom-[280px] xsm:bottom-[51px]
            ...
            <section>
                <div className="w-full h-[290px] bg-black lg:px-28 px-4 items-center lg:py-20 md:py-20 py-10">
                    <div className="flex flex-col">
                        <h2 className="text-white lg:text-[40px] text-[24px] lg:leading-[44px] leading-[32px] font-bold lg:w-[483px]"
            ...
            {/* Section: Insurance Types Accordion */}
            <section>
                <div className="relative overflow-hidden">
                    <img
                        ...
                        alt="Comprehensive motor insurance options"
                        loading="lazy"
                    />
                        ...
                        <div className="p-4 max-h-[400px] overflow-y-scroll scrollbar-hide">
                            ...
                            <div className="mb-4">
                                <div className="flex items-center justify-between">
                                    <h3 className={`${isExpanded.comprehensive ? "text-black lg:text-[24px] text-[16px]" : "text-[#888991]"}`}>
                                ...
                                {isExpanded.comprehensive && (
                                    <>
                                        ...
                                        <div className="flex gap-4">
                                            <span onClick={() => setIsModalOpen(true)} className={`w-[142px] h-[36px] ${accentBg} font-semibold text-[14px] leading-[20px] cursor-pointer rounded-lg shadow-md text-white flex items-center justify-center mt-6`}>
                                                Insurance Features
                                            </span>
                                            <span className="w-[142px] h-[36px] bg-[#F7F7F8] font-semibold text-[14px] leading-[20px] cursor-pointer shadow-md text-black flex items-center justify-center mt-6">
                                                <Link to="https://ecoronation.com/motor" target='_blank' rel='noopener noreferrer'
                                                    onClick={() => trackBuyInsurance('Motor - Comprehensive')}>
                                                    Buy Insurance
                                                </Link>
                                            </span>
                            ...
                            <div className="mb-4">
                                <div className="flex items-center justify-between">
                                    <h3 className={`${isExpanded.thirdPartyFire ? "text-black lg:text-[24px] text-[16px]" : "text-[#888991]"}`}>
                                ...
                                {isExpanded.thirdPartyFire && (
                                    <>
                                        ...
                                        <div className="flex gap-4">
                                            <span onClick={() => setIsTravelModalOpen(true)} className={`w-[142px] h-[36px] ${accentBg} font-semibold text-[14px] leading-[20px] cursor-pointer rounded-lg shadow-md text-white flex items-center justify-center mt-6`}>
                                                Insurance Features
                                            </span>
                                            <span className="w-[142px] h-[36px] bg-[#F7F7F8] font-semibold text-[14px] leading-[20px] cursor-pointer shadow-md text-black flex items-center justify-center mt-6">
                                                <Link to="https://ecoronation.com/motor" target='_blank' rel='noopener noreferrer'
                                                    onClick={() => trackBuyInsurance('Motor - Third Party Fire & Theft')}>
                                                    Buy Insurance
                                                </Link>
                                            </span>
                                            <a href={ProductFlyer} download="Product_Flyers.pdf" className={`w-[142px] h-[36px] ${accentBg} font-semibold text-[14px] leading-[20px] cursor-pointer rounded-lg shadow-md text-white flex items-center justify-center mt-6`}>
                            ...
                            <div className="mb-4">
                                <div className="flex items-center justify-between">
                                    <h3 className={`${isExpanded.thirdPartyOnly ? "text-black lg:text-[24px] text-[16px]" : "text-[#888991]"}`}>
                                        THIRD PARTY ONLY
                                    </h3>
                                ...
                                {isExpanded.thirdPartyOnly && (
                                    <>
                                        ...
                                        <div className="flex gap-4">
                                            <span onClick={() => setIsPartyModalOpen(true)} className={`w-[142px] h-[36px] ${accentBg} font-semibold text-[14px] leading-[20px] cursor-pointer rounded-lg shadow-md text-white flex items-center justify-center mt-6`}>
                                                Insurance Features
                                            </span>
                                            <span className="w-[142px] h-[36px] bg-[#F7F7F8] font-semibold text-[14px] leading-[20px] cursor-pointer shadow-md text-black flex items-center justify-center mt-6">
                                                <Link to="https://ecoronation.com/motor" target='_blank' rel='noopener noreferrer'
                                                    onClick={() => trackBuyInsurance('Motor - Third Party Only')}>
                                                    Buy Insurance
                                                </Link>
                                            </span>
                                            <a href={ProductFlyer} download="Product_Flyers.pdf" className={`w-[142px] h-[36px] ${accentBg} font-semibold text-[14px] leading-[20px] cursor-pointer rounded-lg shadow-md text-white flex items-center justify-center mt-6`}>
                    ...
                    <div className="w-full lg:h-[450px] md:h-[500px] h-[700px]">
                        <div className="w-full h-[108px]">
                            ...
                            <div className="flex lg:flex-row md:flex-row flex-col lg:items-center justify-between">
                                ...
                                <div className={`w-[122px] h-[36px] ${accentBg} font-semibold text-[14px] leading-[20px] cursor-pointer rounded-lg shadow-md text-white flex items-center justify-center mt-6`}>
                                    <Link to="https://ecoronation.com/motor" target='_blank' rel='noopener noreferrer'
                                        onClick={() => trackBuyInsurance('Motor')}>
                                        Buy Insurance
                                    </Link>
                                </div>
                            </div>
                    ...
                    <div className="flex lg:flex-row flex-col gap-10 items-center">
                        <div className="flex-1">
                            <h2 className="lg:text-[40px] text-[28px] font-bold lg:leading-[48px] leading-[36px] text-[#141415]">
                                Get Your Free Motor Insurance Quote Today
                            </h2>
                            <p className="text-[#56575D] lg:text-[18px] text-[14px] mt-4 lg:w-[500px]">
                                Protect your vehicle with Ghana's most trusted insurance provider. Whether you need comprehensive coverage or third-party insurance, we've got you covered.
                            </p>
                        ...
                        <div className="flex-1 w-full max-w-[500px]">
                            <GetQuoteForm productType="Motor Insurance" accentColor={accentColor} />
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section>
                <div className="relative">
                    <img src={product5} alt="Get insured today" className="hidden lg:block w-full bg-cover" />
                    <img src={motorbanner} alt="Get insured today" className="lg:hidden block w-full bg-cover" />
                    <div className="absolute top-[48%] left-[7%] lg:text-[56px] text-[32px] font-semibold leading-[64px] text-white">
                        Get Insured Today
                    </div>
                    <div className="hidden bg-white absolute top-[48%] right-[7%] w-[130px] h-[44px] lg:flex rounded-lg items-center justify-center text-[16px] leading-[24px] font-semibold">
                        <Link to="https://ecoronation.com/motor" target='_blank' rel='noopener noreferrer'
                            onClick={() => trackBuyInsurance('Motor')}>
                            Buy Insurance
                        </Link>
